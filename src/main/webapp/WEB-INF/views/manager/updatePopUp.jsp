...
<body>
	<div id="updatePopup" class="hidden">
		<form action="/content/updateContent" id="updatePopup" method="POST"
			...
			<div id="close-container">
				...
				<div class="div1" id="popup-top">
					<section id="address-category">
						...
						<section>
							<input type="text" name="placeAddress" id="updateInputAddress"
								placeholder="주소">
						</section>
			...
			<div class="container">
				...
				<div class="div1">
					...
					<section id="title-category-place-imgFile">
						...
						<input type="text" name="travelName" id="updateInputPlace"
							placeholder="여행지명"> <select name="areaCode"
							id="updateAreaCode">
						...
						</select> <label for="imageInputUpdate"> 파일선택 </label> <input type="file"
							name="uploadPlaceImg" id="imageInputUpdate" accept="image/*">

					</section>

					<section id="placeZY">
						<div>
							위도 : <input name="latitude" id="updateLatitude"
								class="input-placeZY">
						</div>
						<div>
							경도 : <input name="longitude" id="updateLongitude"
								class="input-placeZY">
						</div>
					</section>
					...
					<section id="info-url-upload-btn">
						<div>
							링크 : <input type="url" name="placeUrl" id="updatePlaceInfoUrl"
								placeholder="관련 사이트 링크">
						</div>
				...
				<div id="div2">
					<section id="place-info">
						설명
						<textarea name="placeInfo" id="updateInputInfo"
					...
					<section id="review-controll">
						...
						<section id="review-controll-section" style="overflow: scroll;">
							...
							<c:forEach var="list" items="${replyList}">
								...
								<p id="review-controll-section-p">${list}</p>
