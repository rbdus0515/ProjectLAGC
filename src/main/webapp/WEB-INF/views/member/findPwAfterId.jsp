		...
		<div class="content2">
			...
			<form action="/member/changePw" method="post" id="emailFrm">
				...
				<section class="findPwContainer">
					...
					<div id="noUse">
						<input type="radio" name="wayToFindPw" class="findPwRadio"
							id="findPwByPhone" value="checkByPhone"> <label
							for="findPwByPhone"> 휴대전화로 인증하기 </label>
					...
					<div>
						<input type="radio" name="wayToFindPw" class="findPwRadio"
							id="findPwByEmail" value="checkByEmail" checked> <label
							for="findPwByEmail"> 이메일로 인증하기 </label>
