		...
		<c:if test="${loginMember.memberManagerFlag == 'N'}">
							...
							<div class="like-list-main">
								<div>
									<button class="left-arrow">
										<img class="arrow-button"
											src="/resources/img/myPage/left-arrow.png">
									</button>
								</div>
									...
									<div class="slideBox">
										...
										<c:forEach var="like" items="${likeList}">
											...
											<div class="like-list-1">
												...
												<a href="/content/detail?area=${like.AREA_CODE}"> <img class="like-list-photo"
													src="${like.CONTENT_IMG}">
								...
								<div>
									<button class="right-arrow">
										<img class="arrow-button"
											src="/resources/img/myPage/right-arrow.png">
									</button>
								</div>
							</div>
						</div>
			...
			<section class="under">
				<div class="my-plan">
					...
					<div class="my-plan-1">
						...
						<div class="plan-main">
							<div class="plan-title">
								<a href="/myPlan/myPlans">수도권 여행</a>
							</div>
					...
					<div class="my-plan-1">
						<a href="#"><img class="my-plan-img"
							src="/resources/img/myPage/오설록 티뮤지엄 5.png"></a>
						<div class="plan-main">
							<div class="plan-title">
								<a href="#">홍길동님의 여행지</a>
							</div>
			...
			<section id="managerSection">
				...
				<main id="mainManager">
					...
					<section class="managingContent">
						<a href="/manager/managingQNA">1:1문의 목록 <c:if
								test="${QNACount != 0}">
